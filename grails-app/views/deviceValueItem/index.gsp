...
<div class="box-inner">
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> 设备参数</h2>
        <div class="box-icon">
...
<div class="box-content">
    <form class="form-inline" role="form" action="#">
        <div class="form-group">
            <label class="control-label" for="catalogId">名称:</label>
...
<script>
    ...
    $(document).ready(function(){
        var table=$('#dataTable').DataTable({
            ...
            "columns": [
                ...
                { "title": "标签", "data" : "label", "orderable": true, "searchable": false },
                { "title": "单位", "data" : "unit", "orderable": true, "searchable": false },
                { "title": "最小值", "data" : "minValue", "orderable": true, "searchable": false },
                { "title": "最大值", "data" : "maxValue", "orderable": true, "searchable": false },
    ...
    function addInfo() {
        var url = '${createLink(controller: "deviceValueItem", action: "create")}';
        $.ajax({
            type: "GET",
            url: url,
    ...
    function editInfo(id) {
        var url = '${createLink(controller: "deviceValueItem", action: "edit")}/' + id;
        $.ajax({
            type: "GET",
            url: url,
            data: "id=" + id,
    ...
    function postAjaxRemove(id) {
        var url = '${createLink(controller: "deviceValueItem", action: "delete")}/' + id;
        $.ajax({
            type: "DELETE",
            dataType: "json",
            url: url,
    ...
    function postAjaxForm() {
        var url = '${createLink(controller: "deviceValueItem", action: "save")}';
        $.ajax({
            type: "POST",
            dataType: "json",
            url: url,
