...
<div class="box-inner">
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> 设备信息</h2>
        <div class="box-icon">
...
<script>
    ...
    $(document).ready(function(){
        var table=$('#dataTable').DataTable({
            ...
            "columns": [
                ...
                { "title": "容量", "data" : "installedCapacity", "orderable": true, "searchable": false },
                { "title": "分类", "data" : "catalogName", "orderable": false, "searchable": false },
    ...
    function addInfo() {
        var url = '${createLink(controller: "deviceInfo", action: "create")}';
        $.ajax({
            type: "GET",
            url: url,
    ...
    function showInfo(id) {
        var url = '${createLink(controller: "deviceInfo", action: "show")}/' + id;
        $.ajax({
            type: "GET",
            url: url,
            data: "id=" + id,
    ...
    function editInfo(id) {
        var url = '${createLink(controller: "deviceInfo", action: "edit")}/' + id;
        $.ajax({
            type: "GET",
            url: url,
            data: "id=" + id,
    ...
    function postAjaxRemove(id) {
        var url = '${createLink(controller: "deviceInfo", action: "delete")}/' + id;
        $.ajax({
            type: "DELETE",
            dataType: "json",
            url: url,
    ...
    function postAjaxForm() {
        var url = '${createLink(controller: "deviceInfo", action: "save")}';
        $.ajax({
            type: "POST",
            dataType: "json",
            url: url,
