...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.ybg.hzt.sys.SystemUser'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.ybg.hzt.sys.SystemUserRole'
grails.plugin.springsecurity.auth.loginFormUrl = '/login/form'
grails.plugin.springsecurity.authority.className = 'com.ybg.hzt.sys.SystemRole'
